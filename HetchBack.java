...
public class HatchBack {
    public static void HatchBackCS() {
        System.out.println("1. BS01\t:Basic_Servicing :\t₹ 2,000/-");
        System.out.println("2. EF01\t:Engine_Fixing\t:\t₹ 5,000/-");
        System.out.println("3. CF01\t:Clutch_Fixing\t:\t₹ 2,000/-");
        System.out.println("4. BF01\t:Brake_Fixing\t:\t₹ 1,000/-");
        System.out.println("5. GF01\t:Gear_Fixing\t:\t₹ 3,000/-");
        System.out.println();
